	...
	<body>
		...
		<div class="container-fluid">
			...
			while($destination = mysqli_fetch_array($destinationArray))  
                {
                $i = 1;
            echo '<a href="'.$destination[5].'"target="_blank"; class="btn button1" style="margin-bottom: 4px;white-space: normal;overflow: hidden; ">';
			echo '<img src="Images/'.$destination[6].'" alt="'.$destination[1].'" align="middle" width="250"/>';

...
$result = mysqli_query($connect, "SELECT * FROM tbl_adminlogin WHERE `admin_purgeFlag` = 1 AND admin_adminName != '$username'"); // using mysqli_query instead
//ORDER BY admin_adminName DESC 
                ?>
                <div style="padding:70px;overflow:scroll;" >
                    <form method="post" action="TVAdminUserAdd.php"> 
                        <p style="font-size: 35px; color: #000;">
                            ...
                            <a href="TVAdminUserRestore.php" class="btn btn-info" role="button">Restore Deleted Users</a>
...
<!--<a href="TVAdminUserAdd.php" class="btn btn-info" role="button">Register/Add User</a>-->
                    ...
                    <div class="table-responsive" id="users_table">  
                            <table style="width: 2000px;" id="destination" class="table table-hover" style="width:1500px">  
                                ...
                                {  
                                    ...
                                    <tr>
                                        <td>
                                            <a title="Edit" class="btn btn-success" href="TVAdminUserEdit.php?id=<?php echo$row['admin_adminName']; ?>"><span class="glyphicon glyphicon-pencil"></span></a> 
                                        </td>
                                        <td> 
                                            <a title="Delete" class="btn btn-danger" href="TVAdminUserDelete.php?id=<?php echo$row['admin_adminName']; ?>" onClick="return confirm('Are you sure you want to delete?')"><span class="glyphicon glyphicon-trash"></span></a>
                                        </td>

    ...
    <body>
        <div class="wrapper">
            ...
            <div id="content">
                ...
                $query = "SELECT * FROM tbl_tourpackage WHERE package_purgeFlag = 0 ORDER BY package_ID DESC";  
                ...
                <div style="padding:70px;">
                    <form method="post" action="TVAdminDestinationAdd.php"> 
                        <p style="font-size: 35px; color: #000;">
                            <strong>Restore Tour Packages</strong> 
                            <a href="TVAdminPackages.php" class="btn btn-info" role="button">Back to Tour Packages</a>
                        ...
                        <div class="table-responsive" id="destination_table">  
                            <table id="tourpackage" class="table table-hover" style="width:1500px">  
                                ...
                                {  
                                    ...
                                    <tr>
                                        <td>
                                            <a title="restore" class="btn btn-success" href="TVAdminPackageReviveTour.php?id=<?php echo $row['package_ID']; ?>"><span class="glyphicon glyphicon-plus"></span></a> 
                                        </td>
                                        <td> 
                                            <a title="Delete" class="btn btn-danger" href="TVAdminPackageDeleteTourFinal.php?id=<?php echo$row['package_ID']; ?>" onClick="return confirm('Are you sure you want to delete?')"><span class="glyphicon glyphicon-trash"></span></a>
                                        </td>
                        ...
                        <br>
                        <p style="font-size: 35px; color: #000;">
                            <strong>Restore Custom Packages</strong>
                            <a href="TVAdminPackages.php" class="btn btn-info" role="button">Back to Custom Packages</a>
                        ...
                        <div class="table-responsive" id="destination_table">  
                            <?php 
                                $query = "SELECT * FROM tbl_createnewpackage WHERE np_purgeFlag = 0 ORDER BY np_ID DESC";  
                                $result = mysqli_query($connect, $query);  
                            ?>
                            <table id="custompackage" class="table table-hover" style="width:1500px">  
                                ...
                                {  
                                    ...
                                    <tr>
                                        <td>
                                            <a title="restore" class="btn btn-success" href="TVAdminPackageReviveCustom.php?id=<?php echo $row['np_ID']; ?>"><span class="glyphicon glyphicon-plus"></span></a> 
                                        </td>
                                        <td> 
                                            <a title="Delete" class="btn btn-danger" href="TVAdminPackageDeleteCustomFinal.php?id=<?php echo$row['np_ID']; ?>" onClick="return confirm('Are you sure you want to delete?')"><span class="glyphicon glyphicon-trash"></span></a>
                                        </td>

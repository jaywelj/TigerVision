...
if(isset($_POST['reservationNo']))
{
	...
	{
		$output.='
		<p style="font-family: Cambria; font-weight:bold; font-size:30px; text-align: center;  margin:0px 50px 0px 50px">Sorry, we cannot find a record of this reservation.</p>';
	}

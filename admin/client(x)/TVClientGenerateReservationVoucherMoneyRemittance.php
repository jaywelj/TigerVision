...
$voucher->Cell(189	,5	,"",0,1);
$voucher->SetFont('Arial','','12');
$voucher->Cell(189	,5	,"A. Money Remittance (Preferred)",0,1);
...
$voucher->Cell(189	,5	,"",0,1);
$voucher->SetFont('Arial','','12');
$voucher->Cell(189	,5	,"B. Bank Deposit",0,1);
$voucher->Cell(15	,5	,"",0,0,'R');
...
$voucher->Cell(189	,5	,"",0,1);
$voucher->SetFont('Arial','','12');
$voucher->Cell(189	,5	,"C. Walk In",0,1);
$voucher->Cell(15	,5	,"",0,0,'R');
$voucher->Cell(159	,5	,"Step 1: Visit us directly at our office to settle your payment.",0,1);
$voucher->SetFont('Arial','B','12');
$voucher->Cell(40	,10	,"",0,0,'R');
$voucher->Cell(149	,10	,"Office Address",0,1);
$voucher->SetFont('Arial','','12');
$voucher->Cell(20	,5	,"",0,0,'R');
$voucher->Cell(20	,5	,"",0,0);
$voucher->Cell(99	,5	,"G/F One Victoria Plaza, A Mabini, Kapasigan, Pasig City",0,1);

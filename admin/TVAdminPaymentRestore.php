    ...
    <body>
        <div class="wrapper">
            ...
            <div id="content">
                ...
                $query = "SELECT * FROM tbl_payments WHERE payment_purgeFlag = 0 GROUP BY payment_ID DESC";  
                            ...
                            <table id="reservation" class="table table-hover" style="width:1500px">  
                                ...
                                {  
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a title="PaymentRestore" class="btn btn-success" href="TVAdminPaymentRevive.php?id=<?php echo $row['payment_ID']; ?>"><span class="glyphicon glyphicon-plus"></span></a> 
                                        </td>
                                        <td> 
                                            <a title="PaymentDelete" class="btn btn-danger" href="TVAdminPaymentDeleteFinal.php?id=<?php echo$row['payment_ID']; ?>" onClick="return confirm('Are you sure you want to delete?')"><span class="glyphicon glyphicon-trash"></span></a>
                                        </td>

...
$varcharPaymentID=$_GET['paymentid'];

$reservationQuery="SELECT * FROM tbl_reservation WHERE reservation_ID = $varcharReservationID";
$paymentQuery="SELECT * FROM tbl_payments WHERE payment_ID = $varcharPaymentID";
echo"$varcharReservationID";
echo"<br>";
echo"$varcharPaymentID";
...
while($res2=mysqli_fetch_array($paymentArray))
{
    ...
    $varcharPaymentproof = $res2['payment_proof'];
...
if($varcharPaymenttype="Full Paid")
{

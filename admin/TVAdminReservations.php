    ...
    <body>
        <div class="wrapper">
            ...
            <div id="content">
                ...
                $query = "SELECT * FROM tbl_reservation WHERE reservation_purgeFlag = 1";  
                    ...
                    <form method="post" action="TVAdminReservationAdd.php"> 
                        <p style="font-size: 35px; color: #000;">
                            ...
                            <button title="Add" type="submit" name="btnAdd" class="btn btn-info btn-lg pull-right" ><span class="glyphicon glyphicon-plus"></button>
                                <a href="TVAdminReservationRestore.php" class="btn btn-info" role="button">Restore Deleted Reservation</a>
                        ...
                        <div class="table-responsive" id="destination_table">  
                            <table id="reservation" class="table table-hover" style="width:1500px">  
                                ...
                                {  
                                    ...
                                    <tr>
                                        <td>
                                            <a title="Edit" class="btn btn-success" href="TVAdminReservationEdit.php?id=<?php echo $row['reservation_ID']; ?>"><span class="glyphicon glyphicon-pencil"></span></a> 
                                        </td>
                                        <td> 
                                            <a title="Delete" class="btn btn-danger" href="TVAdminReservationDelete.php?id=<?php echo $row['reservation_ID']; ?>" onClick="return confirm('Are you sure you want to delete?')"><span class="glyphicon glyphicon-trash"></span></a>
                                        </td>
                                        <td> 
                                            <a title="SendCancelled" class="btn btn-info" href="TVAdminReservationCancelledMail.php?id=<?php echo $row['reservation_ID']; ?>" onClick="return confirm('Are you sure you want to resend email?')"><span class="glyphicon glyphicon-envelope"></span></a>
                                        </td>
                                        ...
                                        <td> <?php echo $row['reservation_schoolName'];?> </td>
                                        ...
                                        <td> <?php echo $row['reservation_change'];?> </td>
                                    </tr>  
                           <?php
                                }
                           ?> 

    ...
    <body>
        <div class="wrapper">
            ...
            <div id="content">
                ...
                $query = "SELECT * FROM tbl_destination WHERE `destination_purgeFlag` = 1 AND `destination_ID` != 1 ORDER BY destination_ID DESC";
                ...
                <div style="padding:70px;">
                    <form method="post" action="TVAdminDestinationAdd.php"> 
                        <p style="font-size: 35px; color: #000;">
                            ...
                            <a href="TVAdminDestinationRestore.php" class="btn btn-info" role="button">Restore Deleted Destinations</a>
                        ...
                        <div class="table-responsive" id="destination_table">  
                            <table style="width: 2000px;" id="destination" class="table table-hover" style="width:1500px">  
                                <tr>  
                                    ...
                                    <th style="width: 10px;"></th>
                                    <th style="width: 100px;">Destination ID</th>
                                    <th style="width: 100px;">Destination Name</th>
                                ...
                                {  
                                    ...
                                    <tr>
                                        <td>
                                            <a title="Edit" class="btn btn-success" href="TVAdminDestinationEdit.php?id=<?php echo$row['destination_ID']; ?>"><span class="glyphicon glyphicon-pencil"></span></a> 
                                        </td>
                                        <td> 
                                            <a title="Delete" class="btn btn-danger" href="TVAdminDestinationDelete.php?id=<?php echo$row['destination_ID']; ?>" onClick="return confirm('Are you sure you want to delete?')"><span class="glyphicon glyphicon-trash"></span></a>
                                        </td>
